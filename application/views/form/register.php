<div class="clear">&nbsp;</div>
<?php if(isset($status)):?>
<div class="alert <?php echo $status?'alert-success':'alert-warning';?> alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>Error!</strong> <?php echo $msg; ?>
</div>
<?php endif; ?>

<form method="post" action="<?php echo site_url('/register/save'); ?>" name="patient_register" id="patient_register">
  ...
  <div class="col-md-12 text-center">
      <button class="btn btn-primary btn-lg" type="button" id="savePatient" >Save &amp; Next&nbsp;<i class="glyphicon glyphicon-menu-right"></i></button>
  </div>
</form>